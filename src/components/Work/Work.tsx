...
const Work: React.FC = () => {
  return (
    <div className="bg-[url('./assets/imgs/bg/bg-mobile.png')] lg:bg-[url('./assets/imgs/bg/bg-work.png')] bg-boiler flex flex-col items-center px-4 sm:px-8 bg-scroll lg:bg-fixed">
